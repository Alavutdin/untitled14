...
import seminar1.seminarDj.task1.gb.task4.exception.CustomerNotExistException;
import seminar1.seminarDj.task1.gb.task4.exception.ProductNotExistException;
import seminar1.seminarDj.task1.gb.task4.exception.QuantityException;
...
public class Main {
    public static void main(String[] args) throws CustomerNotExistException, ProductNotExistException, QuantityException {
        ...
        OnlineShop.getProductList().add(new Product("apple", BigDecimal.valueOf(20L)));
        OnlineShop.getProductList().add(new Product("pineapple", BigDecimal.valueOf(60L)));
